...
if page == "Dashboard":
    ...
    st.title("TEAM - WINFINITY")
    st.markdown("""
    ## About Us
        We are from COORG INSTITUTE OF TECHNOLOGY,KODAGU. We are here to showcase
        our talent in the field of tech and also gain experience from the hackathons.
